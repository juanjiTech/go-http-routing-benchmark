...
func BenchmarkJin_Param(b *testing.B) {
	router := loadJinSingle("GET", "/user/:name", jinHandle)
...
func BenchmarkJin_Param5(b *testing.B) {
	router := loadJinSingle("GET", fiveColon, jinHandle)
...
func BenchmarkJin_Param20(b *testing.B) {
	router := loadJinSingle("GET", twentyColon, jinHandle)
...
func BenchmarkJin_ParamWrite(b *testing.B) {
	router := loadJinSingle("GET", "/user/:name", jinHandleWrite)
